...
import { ArrowLeft, Car, Bike, Save, Loader2, Upload, X } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      <div className="bg-secondary text-white py-16 border-b-8 border-primary relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-black tracking-tight">Edit <span className="text-primary">Listing</span></h1>
        </div>
      </div>

      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 -mt-12 relative z-20">
        <form onSubmit={handleSubmit} className="bg-white rounded-[2rem] p-10 shadow-2xl border border-gray-100 space-y-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold uppercase tracking-widest text-gray-400">
                {formData.type === 'car' ? 'Kilometers Driven' : 'Odometer (Kms)'}
              </label>
              <input 
                required
                type="number" 
                ...
                onChange={(e) => setFormData({...formData, mileage: e.target.value === '' ? 0 : parseInt(e.target.value)})}
              />
            </div>
            <div className="space-y-2">
              <label className="text-xs font-bold uppercase tracking-widest text-gray-400">
          ...
          <div className="pt-6 border-t border-gray-100 flex flex-col md:flex-row gap-4 items-center">
             ...
             >
               {saving ? 'Updating...' : <><Save /> Update Listing</>}
             </button>
             <Link 
               href="/admin" 
